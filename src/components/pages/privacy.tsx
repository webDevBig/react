    ...
    <>
      <Box className='rwrds_sc'>
        <Container>
          ...
          <div>
            <p>
              This Privacy Policy describes how Coinxpad (referred to herein as
              "Coinxpad", "we", "us" or "our"), a company formed pursuant to the
              laws of the Republic of Panama, will manage end user&rsquo;s
              personal data collected. This Policy, in consonance with our
              Terms, applies to your use of Coinxpad platform.
            </p>
            <p>
              By accessing the platform and using our services, you consent to
              the collection, storage, use, and disclosure of your personal
              data, in accordance with this Privacy Policy. We will not collect
              any information from you, except where it is knowingly and
              explicitly provided by you.
            </p>
            <p>
              Coinxpad is committed to respecting your privacy and ensuring that
              the personal data we collect about you is protected and is used,
              stored and disclosed in accordance with this Privacy Policy.
              ...
              or provide TrustPad platforms with your personal data.
            </p>

            <strong>1. Reasons We Collect Your Data</strong>

            <p>
              1.1. Coinxpad will collect your Personal Data only by lawful and
            ...
            <ul>
              ...
              <li>To update you on technical progress of Coinxpad;</li>
              <li>
                To contact you in relation to the management and administration
                of your Coinxpad account
              </li>
              <li>
              ...
              <li>
                To take appropriate action if Coinxpad has reason to suspect
            ...
            <p>
              ...
              Red Kite with the Personal Data we request, we may be unable to
              process your request to become a User, provide you with our
              services or respond to your enquiry or complaint. Examples of
              Personal Data That may be collected by Coinxpad include your name,
              ...
              becoming a User or otherwise choosing to provide Coinxpad with
              Personal Data You consent to Coinxpad collecting, using and
            ...
            <p>
              2.1. The types of Personal Data that Coinxpad may collect from you
              are:
            </p>
            <ul>
              <li>
            ...
            <p>
              2.2. With regard to each of your visits to our Coinxpad platform
            ...
            <ul>
              ...
              <li>
                ...
                Coinxpad (including date and time);
              </li>
              <li>
              ...
              <li>
                Information regarding the provision of Coinxpad services we
                might receive from any other sources.
              </li>
            </ul>

            <strong>3. Collection of Your Data</strong>

            <p>
              3.1. You directly provide Coinxpad with most of the data we
              collect. We collect data and process data when you:
            </p>
            <ul>
              <li>Register online and use the Coinxpad platform services;</li>
              <li>
            ...
            <strong>4. Management of Your Data</strong>

            <p>
              4.1. Coinxpad will take all reasonable steps to ensure that the
            ...
            <p>
              4.2. Coinxpad will destroy or permanently de-identify the Personal
              Data we hold when it is no longer required for any purpose
              permitted.
            </p>

            <strong>5. Security of Your Data</strong>
            ...
            <p>
              ...
              transmit. Any information which you transmit to Coinxpad is
            ...
            <p>
              ...
              protected systems and databases and security technology. Coinxpad
              employees, agents and contractors are required to maintain the
              confidentiality of users&rsquo; Personal Information and trading
              behaviour. We will comply with the requirements of applicable laws
              in the event of a data or security risk.
            </p>

            <strong>6. Law Enforcement</strong>

            <p>
              Under certain circumstances, Coinxpad may be required to disclose
              your Personal Data if required to do so by law or in response to
              valid requests by public authorities (e.g., a court or a
              government agency).
            </p>

            <strong>7. Business Transactions</strong>

            <p>
              You are aware that if Coinxpad is ever involved in a merger,
            ...
            <strong>8. Link to Other Third Parties</strong>
            ...
            <strong>9. Contact Details</strong>
            ...
            <p>
              ...
              data, please also contact us by email. Email: support@coinxpad.io
            </p>
          </div>
        </Container>
      </Box>
